...
class Solution {
    public ListNode addTwoNumbers(ListNode l1, ListNode l2) {
        ...
        int carry = 0;
        while (l1 != null && l2 != null) {// this will ensure that if one of them is null then we can really do anything
                                          // and just can return one of the other

            l1_value = (l1 != null) ? l1_value : 0; // this is saying that if the value of l1 is not null then we
                                                    // //should set the value of the l1_value to 0.
